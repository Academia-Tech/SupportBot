...
Table~\ref{tab:supportbench-results} presents results on the Ardupilot-UA dataset (Ukrainian UAV/drone support community). SupportBot achieves a Score of 8.5/10, outperforming chunked-RAG (6.3, +35\%).
